...
pub fn hexagon_vertices(start: egui::Pos2, distance: f32) -> Vec<Pos2> {
    ...
    for i in 0..6 {
        ...
        let x = start[0] + distance * angle_rad.cos() as f32;
        let y = start[1]+ distance * angle_rad.sin() as f32;
...
fn thrash_bin() {
    /*             let desired_size = ui.spacing().interact_size.y * egui::vec2(2.0, 2.0);
            ...
            let square = egui::Shape::rect_stroke(rect, egui::Rounding::default(), (10.0, egui::Color32::WHITE));
            let mut point = egui::pos2(10.0, 10.0);
            let line = egui::Shape::line_segment([1.0*point, 100.0*point ], (10.0,egui::Color32::WHITE)); */
}